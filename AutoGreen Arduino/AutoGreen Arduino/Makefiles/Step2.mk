...
$(OBJDIR)/libs/%.d: $(APP_LIB_PATH)/%.cpp
	...
	$(call TRACE,"2-APP",$@,$<)
	@mkdir -p $(dir $@)
	$(CXX) -MM $(CPPFLAGS) $(CXXFLAGS) $(CFLAGS) $< -MF $@ -MT $(@:.d=.cpp.o)
...
$(OBJDIR)/%.d: $(VARIANT_PATH)/%.cpp
	...
	$(call TRACE,"6-VARIANT",$@,$<)
	@mkdir -p $(dir $@)
	$(CXX) -c $(CPPFLAGS) $(CXXFLAGS) $(CFLAGS) $< -MF $@ -MT $(@:.d=.cpp.o)
...
#		$(CXX) $(LDFLAGS) -o $@ -Wl,--start-group  $(LOCAL_OBJS) $(INCLUDE_A) $(REMOTE_OBJS) $(TARGET_A) -Wl,--end-group
